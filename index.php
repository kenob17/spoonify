...
<html lang="en">
  ...
  <body class="">
    ...
    <div class="mx-auto pt-20 w-11/12 md:w-1/3 text-center">
      <p class="font-bold text-4xl mb-2" id="title">
        Looking for delicious food recipes online?
      </p>

      <!-- <p class="text-sm text-slate-400 italic">powered by: Spoonacular API</p> -->
      <img class="mb-8 w-full h-60" src="images/homepage.svg" alt="" />

      <p class="mb-2">Click here to get stared.</p>

      <a
        class="w-40 h-12 py-2 px-4 border-1 border-black rounded-2xl font-bold text-xl bg-yellow-400"
        href="searchbyingred.html"
      >
        Get Started
      </a>
      <div class="mt-8 border-b-2 border-base-300"></div>
    </div>

    <div class="h-screen mx-auto w-11/12 mt-8 md:w-1/3 text-center">
      <p class="font-bold text-4xl mb-2" id="title">
        Powered by Spoonacular API
      </p>
      <p class="text-lg">
        access to almost all recipes online is within reach!
      </p>

      <div class="md:flex mt-4">
        <!-- Recipe -->
        <div class="mb-12">
          <img class="mx-auto mt-4" src="images/recipe.png" alt="" />
          <p class="text-2xl mb-2" id="title">over 5,000 recipes</p>
        </div>

        <!-- Ingredients -->
        <div class="mb-12">
          <img class="mx-auto mt-4" src="images/ingredient.png" alt="" />
          <p class="text-2xl mb-2" id="title">over 2,600 ingredients</p>
        </div>

        <!-- Products -->
        <div>
          <img class="mx-auto mt-4" src="images/products.png" alt="" />
          <p class="text-2xl mb-2" id="title">over 600 products</p>
        </div>
      </div>
    </div>
